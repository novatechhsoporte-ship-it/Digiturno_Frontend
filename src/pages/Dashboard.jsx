        ...
        <div className='dashboard__header-right'>
          ...
          <div className='dashboard__user-profile'>
            <div className='dashboard__user-avatar'>
              <Icon name='mdi:account-circle' size='xl' />
            </div>
              ...
              <tbody>
                {recentTurns.map((turn) => (
                  <tr key={turn.id}>
                    ...
                    <td>{turn.tramite}</td>
                    <td>
                      <span className={`dashboard__status-badge dashboard__status-badge--${turn.estado.toLowerCase().replace(" ", "-")}`}>{turn.estado}</span>
                    </td>
                    <td>{turn.tiempo}</td>
                  </tr>
                ))}
